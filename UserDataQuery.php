            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="btn-group float-end" role="group" aria-label="Basic example">
                        <a class="btn btn-primary" href="UserAdd.php">Registrar Usuario</a>
                    </div>
                </div>
                <div class="card-body">
                    <div class="p-4">
                            ...
                            <tbody>
                                <tr>
                                    <?php
                                        ...
                                        while ($datos != null) {
                                            echo "<td class='text-center align-middle'>{$datos['nom_User']}</td>";
                                            echo "<td class='text-center align-middle'>{$datos['correo_User']}</td>";
                                            echo "<td class='text-center align-middle'>{$datos['telefono_User']}</td>";

                                            echo '<td class="text-center align-middle">';
                                            echo '    <div class="row">';
                                            echo '        <div class="col-6">';
                                            echo "           <a class='btn btn-warning' href='UserDataUpdate.php?id={$datos['id_Usuario']}'>";
                                            ...
                                            echo "            <a href='UserShowPerson.php?id={$datos['id_Usuario']}'";
